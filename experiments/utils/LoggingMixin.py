...
class LoggingMixin:
    ...
    def save_model_architecture(model: nn.Module, save_path: str):
        ...
        '''
        import experiments.utils.FancyLayers # Overrides the default __repr__ method for all torch.nn.Module objects so that it shows frozen and trainable layers
